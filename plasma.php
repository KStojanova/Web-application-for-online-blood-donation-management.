    ...
    <div class="navbar navbar-default navbar-static-top">
		<div class="container">
				...
				<div class="navbar-collapse collapse">
                    ...
                    <li><a href="plasma.php">Закажи термин</a></li>
...
?>    </p>     
 ...
 <p style="color:red;">Доколку си излекуван од Ковид 19 закажи термин за донирање на крвна плазма и помогни на оние што се борат со вирусот. </p>
...
$sql = "INSERT INTO krvna_plazma (id_krvodaritel,data, cas) VALUES ('{$_SESSION['id_krvodaritel']}','$data', '$cas')";
...
if (mysqli_query($conn, $sql)) {
  ...
  alert("Успешно закажавте термин за донирање на крвна плазма.");
